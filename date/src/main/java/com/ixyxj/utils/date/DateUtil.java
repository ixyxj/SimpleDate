...
public final class DateUtil {
     ...
     * @return 新日期字符串
     */
    public static String formatToString(String date, String newPattern) {
        DateStyle oldDateStyle = getDateStyle(date);
        return formatToString(date, oldDateStyle, newPattern);
    }
     ...
     * @return 新日期字符串
     */
    public static String formatToString(String date, DateStyle newDateStyle) {
        DateStyle oldDateStyle = getDateStyle(date);
        return formatToString(date, oldDateStyle, newDateStyle);
    }
    ...
    public static String getDate(String date) {
        return formatToString(date, DateStyle.YYYY_MM_DD);
    }
    ...
    public static String getTime(String date) {
        return formatToString(date, DateStyle.HH_MM_SS);
    }
    ...
    public static String getDateTime(String date) {
        return formatToString(date, DateStyle.YYYY_MM_DD_HH_MM_SS);
    }
    ...
    public static int getIntervalDays(Date date, Date otherDate) {
        int num = -1;
        Date dateTmp = DateUtil.parseToDate(DateUtil.getDate(date),
    ...
    public static Season getSeason(String date) {
        ...
        DateStyle dateStyle = getDateStyle(date);
        if (dateStyle != null) {
            Date d = parseToDate(date, dateStyle);
            season = getSeason(d);
        }
        return season;
    }
